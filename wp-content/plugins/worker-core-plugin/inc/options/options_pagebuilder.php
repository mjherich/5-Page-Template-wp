	<div class="wrap">
		...
		<h2><?php _e("Canon Pagebuilder", "loc_worker_core_plugin"); ?></h2>
				...
				<form method="post" action="options.php" enctype="multipart/form-data">
					...
					<!-- BUILDING CONTROLS -->
						<div id="building_control" class="light-box">
							...
							<h3 class="building-title"><?php _e("Template Controls", "loc_worker_core_plugin"); ?></h3>
							<div class="inner-content">
							
								<label><?php _e("Current template", "loc_worker_core_plugin"); ?>:</label>
								...
								<p>
									<label><?php _e("Template name", "loc_worker_core_plugin"); ?>:</label>
									<input type="text" id="template_name" name="canon_options_pagebuilder[name]" value="<?php echo $this_post[0]->post_title; ?>">
								</p>
								
								<button id="action" name="canon_options_pagebuilder[action]" class="button-primary save" value="save"><?php _e("Save Changes", "loc_worker_core_plugin"); ?></button>
								<button id="action" name="canon_options_pagebuilder[action]" class="button-primary clone" value="clone"><?php _e("Clone Template", "loc_worker_core_plugin"); ?></button>
								<button id="action" name="canon_options_pagebuilder[action]" class="button-primary create" value="new"><?php _e("Create New Template", "loc_worker_core_plugin"); ?></button>
								<button id="action" name="canon_options_pagebuilder[action]" class="button-primary delete" value="del"><?php _e("Delete this template", "loc_worker_core_plugin"); ?></button>
					...
					<!-- BLOCK CONTROLS -->
						<div id="block_control" class="light-box">
							...
							<h3 class="building-title"><?php _e("Blocks", "loc_worker_core_plugin"); ?></h3>
							
							<div class="inner-content">
							
								<button id="button_add_block" name="button_add_block" class="button-primary add_block" value="add_block"><?php _e("Add block", "loc_worker_core_plugin"); ?></button>
					...
					<!-- CLIPBOARD -->
						<div id="clipboard" class="light-box" data-status="<?php echo $clipboard_status; ?>">
							...
							<h3 class="building-title"><?php _e("Clipboard", "loc_worker_core_plugin"); ?></h3>
...
------------------------------------------------------>
	...
	<div id="dialog_add_block" title="Add Block">
		...
		<ul id="dialog_building_blocks_filter">
		  <li><a href="#" data-filter="*"><?php _e("Show all", "loc_worker_core_plugin"); ?></a></li>
		  <li><a href="#" data-filter=".block_group_native"><?php _e("Native page elements", "loc_worker_core_plugin"); ?></a></li>
		  <li><a href="#" data-filter=".block_group_functionality"><?php _e("Functionality", "loc_worker_core_plugin"); ?></a></li>
		  <li><a href="#" data-filter=".block_group_layout"><?php _e("Layout", "loc_worker_core_plugin"); ?></a></li>
		</ul>
