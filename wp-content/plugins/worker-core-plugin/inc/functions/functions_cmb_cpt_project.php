...
***************************************/
	...
	function register_cmb_cpt_project () {
		add_meta_box('cmb_cpt_project','Worker Project Settings', 'display_cmb_cpt_project','cpt_project','normal','high');
	}
	...
	***************************************/
	...
	<!-- GENERAL -->
		...
		<div class="option_heading">
			<span><?php _e("Project Slider", "loc_worker_core_plugin"); ?></span>
		</div>
		...
		<div class="option_item">
			...
			<label for='cmb_post_show_post_slider'><?php _e("Show project slider", "loc_worker_core_plugin"); ?></label><br>
		</div>
		...
		<div class="dynamic_option default-hidden" data-listen_to="#cmb_post_show_post_slider" data-listen_for="checked">
			...
			<ul class="wp_galleries_source_hints">
				<li><?php _e("The project slider will replace the featured image at the top of the post.", "loc_worker_core_plugin"); ?></li>
				...
				<li><?php _e("The images from these WordPress galleries will be used in the project slider.", "loc_worker_core_plugin"); ?></li>
