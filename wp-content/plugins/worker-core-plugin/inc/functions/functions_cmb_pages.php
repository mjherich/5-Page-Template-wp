...
***************************************/
	...
	function register_cmb_canon_pages () {
		add_meta_box('cmb_canon_pages','Worker Page Settings', 'display_cmb_canon_pages','page','normal','high');
	}
	...
	***************************************/
		...
		">
			<i><?php _e("No additional page settings available for this template type.", "loc_worker_core_plugin"); ?></i>
		</div>
		...
		<div class=" default_hidden option_template_specific option_page-gallery">
			...
			<div class="option_heading">
				<span><?php _e("Gallery Settings", "loc_worker_core_plugin"); ?></span>
			</div>
			...
			<?php
				...
				fw_cmb_option(array(
					'type'					=> 'select',
					'title' 				=> __('Gallery Style', 'loc_worker_core_plugin'),
					'slug' 					=> 'cmb_gallery_style',
					'select_options'		=> array(
						'slider'				=> __('Gallery Slider', 'loc_worker_core_plugin'),
						'isotope'				=> __('Gallery Isotope', 'loc_worker_core_plugin'),
						'singles'				=> __('Gallery Singles', 'loc_worker_core_plugin'),
						'masonry'				=> __('Gallery Masonry', 'loc_worker_core_plugin'),
					),
					'post_id'				=> $post->ID,
				)); 
				...
				fw_cmb_option(array(
					'type'					=> 'number',
					'title' 				=> __('Number of columns', 'loc_worker_core_plugin'),
		...
		<div class=" default_hidden option_template_specific option_page-blog">
			...
			<div class="option_heading">
				<span><?php _e("Blog Settings", "loc_worker_core_plugin"); ?></span>
			</div>
			...
			<?php
				...
				fw_cmb_option(array(
					'type'					=> 'select',
					'title' 				=> __('Blog Layout', 'loc_worker_core_plugin'),
					'slug' 					=> 'cmb_pages_blog_layout',
					'select_options'		=> array(
						'default'				=> __('Site default', 'loc_worker_core_plugin'),
						'full'					=> __('Blog full width', 'loc_worker_core_plugin'),
						'sidebar'				=> __('Blog with sidebar', 'loc_worker_core_plugin'),
					),
					'post_id'				=> $post->ID,
				)); 
		...
		<div class=" default_hidden option_template_specific option_page-contact">
			...
			<div class="option_heading togglable">
				<span><?php _e("Contact", "loc_worker_core_plugin"); ?></span>
			</div>
			...
			<div class="option_content_container">
				...
				<?php
					...
					fw_cmb_option(array(
						'type'					=> 'checkbox',
						'title' 				=> __('Use embeddable media instead of featured image', 'loc_worker_core_plugin'),
					...
					fw_cmb_option(array(
						'type'					=> 'checkbox',
						'title' 				=> __('Grayscale media <i>(if available)</i>', 'loc_worker_core_plugin'),
					...
					fw_cmb_option(array(
						'type'					=> 'text',
						'title' 				=> __('Embed code', 'loc_worker_core_plugin'),
		...
		<div class=" default_hidden option_template_specific option_page-timeline">
			...
			<!-- CONTACT -->
			<div class="option_heading togglable">
				<span><?php _e("Timeline", "loc_worker_core_plugin"); ?></span>
			</div>
			...
			<div class="option_content_container">
				...
				<div class="option_item">
					<label for='cmb_timeline_cat'><?php _e("Timeline displays", "loc_worker_core_plugin"); ?></label><br>
					<select id="cmb_timeline_cat" name="cmb_timeline_cat"> 
			 			<option value="" <?php if (isset($cmb_timeline_cat)) {if ($cmb_timeline_cat == "") echo "selected='selected'";} ?>><?php _e("All categories", "loc_worker_core_plugin"); ?></option> 

		     			<?php 
		     				foreach ($categories as $single_category) {
		     				?>
		     					<option value="<?php echo $single_category->slug; ?>" <?php if (isset($cmb_timeline_cat)) {if ($cmb_timeline_cat == $single_category->slug) echo "selected='selected'";} ?>><?php echo $single_category->name; ?> <?php _e("category", "loc_worker_core_plugin"); ?></option> 
		     				<?php	     						
		     				}
		     			?>
				...
				<?php
					...
					fw_cmb_option(array(
						'type'					=> 'select',
						'title' 				=> __('Chronology', 'loc_worker_core_plugin'),
						'slug' 					=> 'cmb_timeline_order',
						'select_options'		=> array(
							'DESC'					=> __('Descending', 'loc_worker_core_plugin'),
							'ASC'					=> __('Ascending', 'loc_worker_core_plugin'),
						),
						'post_id'				=> $post->ID,
					)); 
					...
					fw_cmb_option(array(
						'type'					=> 'checkbox',
						'title' 				=> __('Link through to posts', 'loc_worker_core_plugin'),
					...
					fw_cmb_option(array(
						'type'					=> 'checkbox',
						'title' 				=> __('Display content instead of excerpts', 'loc_worker_core_plugin'),
					...
					fw_cmb_option(array(
						'type'					=> 'number',
						'title' 				=> __('Posts per page', 'loc_worker_core_plugin'),
					...
					fw_cmb_option(array(
						'type'					=> 'number',
						'title' 				=> __('Excerpt length', 'loc_worker_core_plugin'),
		...
		<div class=" default_hidden option_template_specific option_page-listing">
			...
			<!-- CONTACT -->
			<div class="option_heading togglable">
				<span><?php _e("Listing", "loc_worker_core_plugin"); ?></span>
			</div>
					...
					<select id="cmb_listing_cat" name="cmb_listing_cat">
	     			<?php 
						...
						$categories = array_values($categories);
	     				...
	     				foreach ($categories as $single_category) {
	     				?>
	     					<option value="<?php echo $single_category->slug; ?>" <?php if (isset($cmb_listing_cat)) {if ($cmb_listing_cat == $single_category->slug) echo "selected='selected'";} ?>><?php echo $single_category->name; ?> <?php _e("category", "loc_worker_core_plugin"); ?></option> 
	     				<?php	     						
	     				}
				...
				<?php
					...
					fw_cmb_option(array(
						'type'					=> 'select',
						'title' 				=> __('Layout', 'loc_worker_core_plugin'),
						'slug' 					=> 'cmb_listing_layout',
						'select_options'		=> array(
							'3'					=> __('3 column', 'loc_worker_core_plugin'),
							'2'					=> __('2 column', 'loc_worker_core_plugin'),
							'1'					=> __('1 column', 'loc_worker_core_plugin'),
						),
						'post_id'				=> $post->ID,
					)); 
					...
					fw_cmb_option(array(
						'type'					=> 'select',
						'title' 				=> __('Order by', 'loc_worker_core_plugin'),
						'slug' 					=> 'cmb_listing_orderby',
						'select_options'		=> array(
							'title'					=> __('Alphabetical', 'loc_worker_core_plugin'),
							'date'					=> __('Date added', 'loc_worker_core_plugin'),
							'cmb_item_price'		=> __('Price', 'loc_worker_core_plugin'),
							'cmb_item_index'		=> __('Index', 'loc_worker_core_plugin'),
						),
						'post_id'				=> $post->ID,
					)); 
					...
					fw_cmb_option(array(
						'type'					=> 'select',
						'title' 				=> __('Order', 'loc_worker_core_plugin'),
					...
					fw_cmb_option(array(
						...
						'title' 				=> __('Item switches', 'loc_worker_core_plugin'),
						'slug' 					=> 'cmb_listing_hide',
						'checkboxes'			=> array(
							'cmb_listing_hide_page_title'			=> __('Hide page title', 'loc_worker_core_plugin'),
							'cmb_listing_hide_page_description'	=> __('Hide page description', 'loc_worker_core_plugin'),
							'cmb_listing_hide_item_image'			=> __('Hide item image', 'loc_worker_core_plugin'),
							'cmb_listing_hide_item_price'			=> __('Hide item price', 'loc_worker_core_plugin'),
							'cmb_listing_hide_item_description'	=> __('Hide item description', 'loc_worker_core_plugin'),
						),
						'post_id'				=> $post->ID,
					)); 
			...
			<!-- SIDEBAR -->
			<div class="option_heading togglable">
				<span><?php _e("Sidebar", "loc_worker_core_plugin"); ?></span>
			</div>
			...
			<?php
				...
				fw_cmb_option(array(
					'type'					=> 'select',
					'title' 				=> __('Sidebar alignment', 'loc_worker_core_plugin'),
					'slug' 					=> 'cmb_listing_sidebar',
					'select_options'		=> array(
						'default'				=> __('Site default', 'loc_worker_core_plugin'),
						'left'					=> __('Left', 'loc_worker_core_plugin'),
						'right'					=> __('Right', 'loc_worker_core_plugin'),
					),
					'post_id'				=> $post->ID,
				)); 
			...
			<div class="option_item">
				<label for='cmb_listing_sidebar_id'><?php _e("Select sidebar", "loc_worker_core_plugin"); ?></label><br>
		...
		<div class=" default_hidden option_template_specific option_page option_default option_page-pagebuilder-sidebar">
			...
			<div class="option_item">
				<label for='cmb_page_sidebar_id'><?php _e("Select sidebar", "loc_worker_core_plugin"); ?></label><br>
		...
		<div class=" default_hidden option_template_specific option_page-blog">
			...
			<div class="option_heading">
				<span><?php _e("Pagebuilder Settings", "loc_worker_core_plugin"); ?></span>
			</div>
			...
			<?php
				...
				fw_cmb_option(array(
					'type'					=> 'select',
					'title' 				=> __('Pagebuilder Blog Attachment', 'loc_worker_core_plugin'),
					'slug' 					=> 'cmb_pages_template_attachment',
					'select_options'		=> array(
						'none'					=> __('Do not attach', 'loc_worker_core_plugin'),
						'prepend'				=> __('Prepend', 'loc_worker_core_plugin'),
						'append'				=> __('Append', 'loc_worker_core_plugin'),
					),
					'post_id'				=> $post->ID,
				)); 
		...
		<div class=" default_hidden option_template_specific option_page-pagebuilder option_page-placeholder option_page-blog option_page-pagebuilder-sidebar">


			<div class="option_item">
				<label for='cmb_template_id'><?php _e("Pagebuilder Template", "loc_worker_core_plugin"); ?></label><br>
