...
***************************************/
	...
	function register_cmb_canon_posts () {
		add_meta_box('cmb_canon_posts','Worker Post Settings', 'display_cmb_canon_posts','post');
	}
	...
	***************************************/
	...
	<!-- GENERAL -->
		...
		<div class="option_heading">
			<span><?php _e("General", "loc_worker_core_plugin"); ?></span>
		</div>
		...
		<div class="options_post_format default_hidden" data-post_format="quote">
			...
			<?php
				...
				fw_cmb_option(array(
					'type'					=> 'checkbox',
					'title' 				=> __('Display quote as a tweet', 'loc_worker_core_plugin'),
				...
				fw_cmb_option(array(
					'type'					=> 'text',
					'title' 				=> __('Quote byline', 'loc_worker_core_plugin'),
					'slug' 					=> 'cmb_byline',
					'class' 				=> 'widefat',
					'post_id'				=> $post->ID,
				)); 
		...
		<?php
			...
			fw_cmb_option(array(
				'type'					=> 'select',
				'title' 				=> __('Post style', 'loc_worker_core_plugin'),
				'slug' 					=> 'cmb_single_style',
				'select_options'		=> array(
					'full'				=> __('Featured full width (standard)', 'loc_worker_core_plugin'),
					'boxed'				=> __('Featured boxed', 'loc_worker_core_plugin'),
					'compact'			=> __('Featured compact', 'loc_worker_core_plugin'),
					'full_sidebar'		=> __('Featured full width w. sidebar', 'loc_worker_core_plugin'),
					'boxed_sidebar'		=> __('Featured boxed w. sidebar', 'loc_worker_core_plugin'),
					'compact_sidebar'	=> __('Featured compact w. sidebar', 'loc_worker_core_plugin'),
					'multi'				=> __('Multi post', 'loc_worker_core_plugin'),
				),
				'post_id'				=> $post->ID,
			)); 
		...
		<div class="dynamic_option default_hidden" data-listen_to="#cmb_single_style" data-listen_for="multi">
			...
			<?php
				...
				fw_cmb_option(array(
					'type'					=> 'textarea',
					'title' 				=> __('Multi post intro', 'loc_worker_core_plugin'),
		...
		<div class="dynamic_option default_hidden" data-listen_to="#cmb_single_style" data-listen_for="full_sidebar boxed_sidebar compact_sidebar">
			...
			<div class="option_item">
				<label for='cmb_sidebar_id'><?php _e("Select sidebar", "loc_worker_core_plugin"); ?></label><br>
		...
		<?php
			...
			fw_cmb_option(array(
				'type'					=> 'select',
				'title' 				=> __('Feature style', 'loc_worker_core_plugin'),
				'slug' 					=> 'cmb_feature',
				'select_options'		=> array(
					'image'				=> __('Featured image', 'loc_worker_core_plugin'),
					'media'				=> __('Use embeddable media instead of featured image', 'loc_worker_core_plugin'),
					'media_in_lightbox'	=> __('Use featured image but open media link in lightbox', 'loc_worker_core_plugin'),
				),
				'post_id'				=> $post->ID,
			)); 
			...
			fw_cmb_option(array(
				'type'					=> 'textarea',
				'title' 				=> __('Featured media - <i>(optional)</i>', 'loc_worker_core_plugin'),
				'slug' 					=> 'cmb_media_link',
				'cols'					=> '100',
				'rows'					=> '5',
				'class'					=> 'widefat',
		...
		<?php
			...
			fw_cmb_option(array(
				...
				'slug' 					=> 'cmb_quote_is_tweet',
				'checkboxes'			=> array(
					'cmb_hide_from_archive'		=> __('Hide from blog', 'loc_worker_core_plugin'),
					'cmb_hide_from_popular'		=> __('Hide from popular lists', 'loc_worker_core_plugin'),
				),
		...
		<?php
			...
			?>
				<div class="option_item">
					...
					<label for='cmb_hide_feat_img'><?php _e("Hide featured image in post", "loc_worker_core_plugin"); ?></label>
				</div>
		...
		<div class="option_heading">
			<span><?php _e("Post Slider", "loc_worker_core_plugin"); ?></span>
		</div>
		...
		<div class="option_item">
			...
			<label for='cmb_post_show_post_slider'><?php _e("Show post slider", "loc_worker_core_plugin"); ?></label><br>
		</div>
		...
		<div class="dynamic_option default-hidden" data-listen_to="#cmb_post_show_post_slider" data-listen_for="checked">
			...
			<ul class="wp_galleries_source_hints">
				<li><?php _e("The post slider will replace the featured image at the top of the post.", "loc_worker_core_plugin"); ?></li>
				<li><?php _e("Add WordPress galleries using the Add Media button. You can add as many WordPress galleries as you would like.", "loc_worker_core_plugin"); ?></li>
				<li><?php _e("The images from these WordPress galleries will be used in the post slider.", "loc_worker_core_plugin"); ?></li>
				<li><?php _e("The images will appear in the same order as they appear in the galleries. Duplicate images will be removed.", "loc_worker_core_plugin"); ?></li>
			</ul>
