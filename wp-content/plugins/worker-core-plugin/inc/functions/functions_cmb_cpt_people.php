...
***************************************/
	...
	function register_cmb_canon_cpt_people () {
		add_meta_box('cmb_canon_cpt_people','Worker People Settings', 'display_cmb_canon_cpt_people','cpt_people','normal','high');
	}
	...
	***************************************/
	...
	<!-- DETAILS -->
		...
		<div class="option_heading">
			<span><?php _e("Details", "loc_worker_core_plugin"); ?></span>
		</div>
		...
		<?php
			...
			fw_cmb_option(array(
				'type'					=> 'text',
				'title' 				=> __('Title / position', 'loc_worker_core_plugin'),
				'slug' 					=> 'cmb_title',
				'class'					=> 'widefat',
				'post_id'				=> $post->ID,
			)); 
			...
			fw_cmb_option(array(
				'type'					=> 'textarea',
				'title' 				=> __('Info', 'loc_worker_core_plugin'),
				'slug' 					=> 'cmb_info',
				'rows'					=> '5',
				'hint'					=> __('Optional. HTML allowed.', 'loc_worker_core_plugin'),
				'class'					=> 'widefat',
				'post_id'				=> $post->ID,
			)); 
			...
			fw_cmb_option(array(
				'type'					=> 'checkbox',
				'title' 				=> __('Display excerpt as quote', 'loc_worker_core_plugin'),
			...
			fw_cmb_option(array(
				'type'					=> 'number',
				'title' 				=> __('Position index <span class="item_hint">(determines order of appearance)</span>', 'loc_worker_core_plugin'),
				'slug' 					=> 'cmb_index',
				'min'					=> '1',										// optional
				'max'					=> '100000',								// optional
				'step'					=> '1',										// optional
	...
	<!-- SOCIAL LINKS -->
		...
		<div class="option_item">
			...
			<label for='cmb_hide_social_links'><?php _e("Hide social links", "loc_worker_core_plugin"); ?></label>
			...
			<table class='form-table cmb_social_links'>
				<?php 
					...
					<tr valign='top' class='cmb_social_links_row'>
						<th scope='row'>Social link <?php echo esc_attr($i);+1; ?></th>
						<td>
							<select class="cmb_social_links_icon fa_select" name='cmb_social_links[<?php echo esc_attr($i);; ?>][icon]'> 
								<?php 
							...
							<input type='text' class='cmb_social_links_link' name='cmb_social_links[<?php echo esc_attr($i);; ?>][link]' value='<?php if (isset($cmb_social_links[$i]['link'])) echo $cmb_social_links[$i]['link']; ?>'>
						</td>
					</tr>
