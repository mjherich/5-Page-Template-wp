	                    	...
	                    	<div class="clearfix">
								...
								<?php
			                        ...
			                        ?>
					                    ...
					                    <?php if ($show_title == "checked" || $show_excerpt == "checked" || $show_more_link == "checked") { echo '<div class="owl-item-boxedContent">'; } ?>
											...
											<!-- excerpt -->
	                                        <?php if ($show_excerpt == "checked") { echo wp_kses_post($the_excerpt); } ?>

				                        	<!-- more link -->
				                        	<?php if ($show_more_link == "checked") { printf('<a class="more" href="%s">%s</a>', esc_url(get_permalink($current_post->ID)), __("more", "loc_worker_core_plugin")); } ?>
										
					                    <?php if ($show_title == "checked" || $show_excerpt == "checked" || $show_more_link == "checked") { echo '</div>'; } ?>
