	                ...
	                <div class="main wrapper clearfix">
	                    ...
	                    <div class="main-content three-fourths">
		                	...
		                	<div class="clearfix">
	                            ...
	                            <!-- WP_LINK_PAGES -->
	                            <?php wp_link_pages(array('before' => '<p>' . __('Pages:','loc_worker_core_plugin'))); ?>
						...
						<aside class="right-aside fourth last">
							...
							<?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar($sidebar_id)) : ?>  
		                        ...
		                        <h4><?php _e("No Widgets added.", "loc_worker_core_plugin"); ?></h4>
		                        <p><i><?php _e("Please login and add some widgets to this widget area.", "loc_worker_core_plugin"); ?></i></p> 
