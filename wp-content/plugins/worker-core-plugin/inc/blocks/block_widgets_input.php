				...
				<!-- BLOCK TAB: GENERAL -->
					<div class="block_tab block_tab_general">
						...
						<div class="option">
							...
							<select class='block_option layout_select' id="layout" name="canon_options_pagebuilder[blocks][<?php echo esc_attr($index); ?>][layout]"> 
				     			<option value="half_half">-- <?php _e("TWO COLUMN LAYOUT", "loc_worker_core_plugin"); ?></option> 
				     			<option value="half_half" <?php if (isset($params['layout'])) {if ($params['layout'] == "half_half") echo "selected='selected'";} ?>>half_half</option> 

				     			<option value="third_third_third">--- <?php _e("THREE COLUMN LAYOUTS", "loc_worker_core_plugin"); ?></option> 
				     			...
				     			<option value="fourth_fourth_fourth_fourth">---- <?php _e("FOUR COLUMN LAYOUTS", "loc_worker_core_plugin"); ?></option> 
				     			...
				     			<option value="fifth_fifth_fifth_fifth_fifth">---- <?php _e("FIVE COLUMN LAYOUTS", "loc_worker_core_plugin"); ?></option> 
						...
						<?php 
							...
							?>
								<div class="option">
									...
									<select class='block_option widget_area_select' id="widget_area" name="canon_options_pagebuilder[blocks][<?php echo esc_attr($index); ?>][widget_area][<?php echo $n; ?>]"> 
