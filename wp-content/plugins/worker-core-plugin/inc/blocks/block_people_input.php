		...
		?>
			...
			<!--  BLOCK CONTENT -->
				...
				<!-- BLOCK TAB: GENERAL -->
					...
					<!-- NUMBER -->
						<div class="option">
							<input 
								type='number' 
								class='block_option'
								name='canon_options_pagebuilder[blocks][<?php echo esc_attr($index); ?>][num_people]' 
								min='1'
								max='100'
								step='1'
								style='width: 45px;'
								value='<?php if (isset($params['num_people'])) echo esc_attr($params['num_people']); ?>'
							><?php _e("Number of people to display", "loc_worker_core_plugin"); ?>
						</div>
					...
					<!-- CHECKBOX -->
						<div class="option">
							<input class='block_option' type="hidden" name="canon_options_pagebuilder[blocks][<?php echo esc_attr($index); ?>][link_through]" value="unchecked" />
							<input class='block_option' type="checkbox" name="canon_options_pagebuilder[blocks][<?php echo esc_attr($index); ?>][link_through]" class="checkbox" value="checked" <?php if (isset($params['link_through'])) { checked($params['link_through'] == "checked"); } ?>/> 
							<?php _e("Link through to single person post", "loc_worker_core_plugin"); ?>
						</div>

					<!-- CHECKBOX -->
						<div class="option">
							<input class='block_option' type="hidden" name="canon_options_pagebuilder[blocks][<?php echo esc_attr($index); ?>][even_height]" value="unchecked" />
							<input class='block_option' type="checkbox" name="canon_options_pagebuilder[blocks][<?php echo esc_attr($index); ?>][even_height]" class="checkbox" value="checked" <?php if (isset($params['even_height'])) { checked($params['even_height'] == "checked"); } ?>/> 
							<?php _e("Even height", "loc_worker_core_plugin"); ?>
						</div>

					<!-- CHECKBOX -->
						<div class="option">
							<input class='block_option' type="hidden" name="canon_options_pagebuilder[blocks][<?php echo esc_attr($index); ?>][hide_excerpt]" value="unchecked" />
							<input class='block_option' type="checkbox" name="canon_options_pagebuilder[blocks][<?php echo esc_attr($index); ?>][hide_excerpt]" class="checkbox" value="checked" <?php if (isset($params['hide_excerpt'])) { checked($params['hide_excerpt'] == "checked"); } ?>/> 
							<?php _e("Hide excerpt", "loc_worker_core_plugin"); ?>
						</div>


					<!-- SELECT -->
						<div class="option">
							<label><?php _e("Order of appearance", "loc_worker_core_plugin"); ?></label>
							<select class='block_option' name="canon_options_pagebuilder[blocks][<?php echo esc_attr($index); ?>][orderby]"> 
					...
					<!-- DYNAMIC CHECKBOXES -->
						...
						<div class="option">
							<label><?php _e("People category to display", "loc_worker_core_plugin"); ?></label>
