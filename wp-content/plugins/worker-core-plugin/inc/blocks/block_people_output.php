    	                	...
    	                	<?php if (!empty($text)) { printf('<p class="lead">%s</p>', do_shortcode($text)); } ?>
	                    		...
	                    		<?php 
	                    			...
	                    			<?php if ( ($i === 0) || ($i%$num_columns === 0) ) { echo '<div class="clearfix">'; } ?>
		    	                		...
		    	                		<div class="<?php echo esc_attr($final_class); ?> personColumn">
		    	                			...
		    	                			<div class="inner-box">
		    	                				...
		    	                				<div class="person_info<?php if ($even_height == "checked") { echo " even-height"; } ?>" data-even_height_group="inner-box-<?php echo esc_attr($block_index); ?>">
			    	                				...
			    	                				<?php 
			    	                					...
			    	                					?>
					    	                				<em class="<?php if ($cmb_excerpt_is_quote == 'checked') { echo "quote"; } ?>"><?php echo wp_kses_post($the_excerpt);; ?></em>
			    	                					<?php	
			    	                					}
