			...
			<!--  BLOCK CONTENT -->
				...
				<!-- BLOCK TAB: GENERAL -->
					<div class="block_tab block_tab_general">
	 				...
	 				<!-- CHECKBOX -->
						<div class="option">
							<input class='block_option' type="hidden" name="canon_options_pagebuilder[blocks][<?php echo esc_attr($index); ?>][hide_title]" value="unchecked" />
							<input class='block_option' type="checkbox" name="canon_options_pagebuilder[blocks][<?php echo esc_attr($index); ?>][hide_title]" class="checkbox" value="checked" <?php if (isset($params['hide_title'])) { checked($params['hide_title'] == "checked"); } ?>/> 
							<?php _e("Hide title", "loc_worker_core_plugin"); ?>
						</div>
