			...
			<!--  BLOCK CONTENT -->
				...
				<!-- BLOCK TAB: GENERAL -->
					<div class="block_tab block_tab_general">
						...
						<div class="option">
							<span class="detail"><?php _e("Displays the featured image of your page. Make sure the page using this pagebuilder template has a featured image.", "loc_worker_core_plugin"); ?></span>
						</div>
