				...
				<!-- BLOCK TAB: GENERAL -->
					...
					<!-- PB SORTABLE -->	
									...
									<li>
										...
										<!-- ICON -->
											...
											<tr>
												...
												<td>
													<select class="block_option fa_select" name='canon_options_pagebuilder[blocks][<?php echo esc_attr($index); ?>][column][<?php echo esc_attr($i);; ?>][icon]'> 
														<?php 
										...
										<!-- TITLE -->
											<tr>
												...
												<td>
													<input class='block_option' type='text' name='canon_options_pagebuilder[blocks][<?php echo esc_attr($index); ?>][column][<?php echo esc_attr($i);; ?>][title]' value="<?php if (isset($params['column'][$i]['title'])) echo htmlspecialchars($params['column'][$i]['title']); ?>">
												</td>
											</tr>

										<!-- TEXT -->
											<tr>
												<th><?php _e("Text", "loc_worker_core_plugin"); ?></th>
												<td>
													<textarea 
														class='block_option' 
														rows = '3'
														name='canon_options_pagebuilder[blocks][<?php echo esc_attr($index); ?>][column][<?php echo esc_attr($i);; ?>][text]'
						...
						<div class="pb_sortable_controls" data-min_num_elements="1" data-max_num_elements="5">
							<input type="button" class="button button_add_to_sortable" value="<?php _e("Add new column", "loc_worker_core_plugin"); ?>" />
						</div>
				...
				<!-- BLOCK TAB: APPEARANCE -->
					<div class="block_tab block_tab_appearance">
						...
						<div class="option">
							...
							<input class='block_option color_input' type="text" name="canon_options_pagebuilder[blocks][<?php echo esc_attr($index); ?>][icon_color]" value="<?php if (isset($params['icon_color'])) echo $params['icon_color']; ?>" />    
							<label class="color_label"><?php _e("Icon Color", "loc_worker_core_plugin"); ?></label>
						</div>	
						...
						<div class="option">
							<input 
								...
								class='block_option'
								id='num_columns' 
								name='canon_options_pagebuilder[blocks][<?php echo esc_attr($index); ?>][icon_size]' 
								min='1'
								max='200'
								step='1'
								style='width: 45px;'
								value='<?php if (isset($params['icon_size'])) echo esc_attr($params['icon_size']); ?>'
							><?php _e("Icon Size <i>(px)</i>", "loc_worker_core_plugin"); ?>
						</div>
