...
/**************************************
WIDGET: widget_worker_facebook
***************************************/

	add_action('widgets_init', 'register_widget_widget_worker_facebook' );
	function register_widget_widget_worker_facebook () {
		register_widget('widget_worker_facebook');	
	}

	class widget_worker_facebook extends WP_Widget {
		...
		***************************************/
		function __construct () {
				...
				$widget_ops = array(
					'classname' => 'widget_worker_facebook', 								
					'description' => __('Display Facebook box', "loc_worker_widgets_plugin")	 				
				);
				$control_ops = array(
					'width' => 350, 
					'height' => 350, 
					'id_base' => 'widget_worker_facebook' 														
				);

				$this->WP_Widget('widget_worker_facebook', __('Worker: Facebook', "loc_worker_widgets_plugin"), $widget_ops, $control_ops );	
		}
		...
		***************************************/
		function form($instance) {
			...
			//defaults
			$defaults = array( 
				'title' 		=> __('Like us on facebook', "loc_worker_widgets_plugin"),
			...
			?>
				...
				<p>
					<label for='<?php echo esc_attr($this->get_field_id('fb_page')); ?>'><?php _e("Facebook Page", "loc_worker_widgets_plugin"); ?>: </label>
				...
				<p>
					<label for='<?php echo esc_attr($this->get_field_id('fb_width')); ?>'><?php _e("Max-width (pixels)", "loc_worker_widgets_plugin"); ?>: </label>
				...
				<p>
					<label for='<?php echo esc_attr($this->get_field_id('fb_height')); ?>'><?php _e("Height (pixels)", "loc_worker_widgets_plugin"); ?>: </label>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id( 'fb_cover' )); ?>"><?php _e("Show cover", "loc_worker_widgets_plugin"); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id( 'fb_faces' )); ?>"><?php _e("Show faces", "loc_worker_widgets_plugin"); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id( 'fb_posts' )); ?>"><?php _e("Show posts", "loc_worker_widgets_plugin"); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id( 'fb_small_header' )); ?>"><?php _e("Small header", "loc_worker_widgets_plugin"); ?></label>
				</p>
		...
		***************************************/
		function widget($args, $instance) {
			...
			<?php echo wp_kses_post($before_title . $title . $after_title); ?>
				...
				>
					<div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/facebook"><a href="https://www.facebook.com/facebook"><?php _e('Facebook page plugin loading...', 'loc_worker_widgets_plugin'); ?></a></blockquote></div>
				</div>
