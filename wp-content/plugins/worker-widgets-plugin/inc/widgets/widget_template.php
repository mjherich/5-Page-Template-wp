		...
		***************************************/
		function __construct () {
				...
				$widget_ops = array(
					...
					'description' => __('YOUR STANDARD TEMPLATE BANNER', "loc_oxie_widgets_plugin")	 				
				);
				$control_ops = array(
					'width' => 300, 
					'height' => 350, 
				...
				$this->WP_Widget('CANON_SIDEBAR_TEMPLATE', __('TEMPLATE_DISPLAY_TITLE', "loc_oxie_widgets_plugin"), $widget_ops, $control_ops );	
		}
			...
			<!-- SELECT -->	
				<p>
					...
					<select id="<?php echo esc_attr($this->get_field_id('display_style')); ?>" name="<?php echo esc_attr($this->get_field_name('display_style')); ?>"> 
	 					...
	 					<option value="text" <?php if (isset($display_style)) {if ($display_style == "text") echo "selected='selected'";} ?>><?php _e("Text", "loc_oxie_widgets_plugin"); ?>	</option> 
					</select> 
				</p>
