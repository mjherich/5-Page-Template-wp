						...
						<table class='form-table'>
							...
							<tr valign='top'>
								...
								<td>
									...
									<input type="button" id="button_generate_data" class="button" value="Generate settings data" data-options_data="<?php echo esc_attr($encoded_serialized_options_data); ?>" />
