		...
		if (get_option('canon_options_frame') == FALSE) {		//trying to get options 'canon_options_frame' which doesn't yet exist results in FALSE
		 	$options = array (
					...
					'header_img_bg_color'			=> '#141312',
		 			...
		 			'header_img_text'				=> "<h3>Header Image With Parallax Scrolling - What's Not To Like!</h3>[button]Buy Worker Today[/button]",
		 			...
		 			'header_text'					=> '<strong>Phone:</strong> 555 555  1234',
					...
					'footer_text'					=> '© Copyright Worker 2014 by <a href="http://www.themecanon.com" target="_blank">Theme Canon</a>',
