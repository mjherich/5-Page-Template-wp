						...
						<table class='form-table'>
							...
							<tr valign='top'>
								...
								<td>
                                    ...
                                    <?php printf("<i>(%s%s %s%.2f)</i>",__("Resized to max width: ", "loc_canon") , esc_attr($canon_options_frame['logo_max_width']), __("pixels. Compression ratio: ", "loc_canon"), $compression_ratio); ?><br>
									<br><br>
								</td>
							</tr>
					...
					-->
						...
						<div class='contextual-help'>
							<?php 
								...
								fw_option_help(array(
									'type'					=> 'standard',
									'title' 				=> __('Show social icons in footer', 'loc_canon'),
									'content' 				=> array(
										__('If checked your social icons will be displayed at the bottom right area of the footer. Notice that social links can also be placed in your header using the Header Builder.', 'loc_canon'),
									),
								)); 
								...
								fw_option_help(array(
									...
									'content' 				=> array(
										__('Clicking a social link will open it up in a new window.', 'loc_canon'),
									),
								)); 
