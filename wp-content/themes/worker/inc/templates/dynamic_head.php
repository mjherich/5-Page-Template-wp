	...
	<!-- FAVICON -->
        ...
        <link rel="shortcut icon" href="<?php if (empty($canon_options['favicon_url'])) {echo get_template_directory_uri() . "/img/default_favicon.ico";} else {echo esc_url($canon_options['favicon_url']);} ?>" />
