            ...
            <div class="main wrapper clearfix">
                ...
                <div class="main-content masonry-gallery">
                    ...
                    <div class="gallery-head clearfix">
                        ...
                        <h3 class="left"><?php echo esc_attr($post->post_title); ?></h3>
                    ...
                    <!-- IMAGES -->
                    <div id="masonry-gallery" class="thumb-gallery super-list variable-sizes clearfix page_masonry_gallery gallery-images" data-num_columns="<?php echo esc_attr($cmb_gallery_num_columns); ?>">
