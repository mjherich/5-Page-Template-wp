                    ...
                    <div class="clearfix">
                        ...
                        <aside class="left-aside left fifth">
                            <ul class="meta option-set filters" id="filter" data-option-key="filter">
                                <li><strong><?php echo esc_attr($post->post_title); ?></strong></li>
                        ...
                        <!-- Start Isotope -->
                        <div class="four-fifths right last thumb-gallery super-list variable-sizes page_isotope_gallery" data-num_columns="<?php echo esc_attr($cmb_gallery_num_columns); ?>">
