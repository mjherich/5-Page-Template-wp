...
<?php 
    ...
    ?>
        ...
        <div class="outter-wrapper header-container image-header-container <?php if ($canon_options_frame['use_sticky_header'] == 'checked') { echo "canon_sticky"; } ?>" data-stellar-background-ratio="<?php echo esc_attr($parallax_ratio); ?>">
