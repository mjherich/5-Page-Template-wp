...
<?php 
    ...
    ?>
        ...
        <div class="outter-wrapper pre-header-container image-header-container <?php if ($canon_options_frame['use_sticky_preheader'] == 'checked') { echo "canon_sticky"; } ?>" data-stellar-background-ratio="<?php echo esc_attr($parallax_ratio); ?>">
