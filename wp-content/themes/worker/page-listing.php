...
<?php 
	...
	$main_content_class = ($sidebar_alignment == 'left') ? 'main-content left-main-content three-fourths' : 'main-content three-fourths';
			...
			<div class="main-container">
				...
				<div class="main wrapper clearfix">
					...
					<div class="<?php echo esc_attr($main_content_class); ?>">
						...
						<?php if($cmb_listing_hide_page_title != "checked") printf('<h1>%s</h1>', esc_attr($post->post_title)); ?>
						<?php if($cmb_listing_hide_page_description != "checked") printf('<p class="lead">%s</p>', do_shortcode($post->post_content)); ?>
							...
							for ($i = 0; $i < count($results_query); $i++) {
								...
								?>
										...
										<div class="<?php echo esc_attr($final_class); ?>">
											...
											<!-- TITLE -->
											<?php if ($cmb_listing_layout != '3') { printf('<h6>%s <span>%s</span></h6>', esc_attr($this_post->post_title), esc_attr($cmb_item_price)); } ?>
