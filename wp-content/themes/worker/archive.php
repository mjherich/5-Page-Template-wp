			...
			<div class="main-container">
				...
				<div class="main wrapper clearfix">
					...
					<div class="<?php echo esc_attr($main_content_class); ?>">
						...
						<!-- RESULTS SUMMARY -->
						<div class="tc-page-heading"><?php echo esc_attr($wp_query->found_posts); ?> <?php if (count($wp_query->posts) !== 1) {_e('Results','loc_canon');} else {_e('result','loc_canon');} ?> <?php _e("for", "loc_canon"); ?> <span><?php printf("%s: <span class='highlight'> %s</span>", esc_attr($archive_title), esc_attr($archive_subject)); ?></span></div>
