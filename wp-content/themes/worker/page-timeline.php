...
<?php 
    ...
    $cmb_timeline_excerpt_length = get_post_meta($post->ID, 'cmb_timeline_excerpt_length', true);    //notice if not set then query defaults to wp posts per page
    ...
    //localize script
    wp_localize_script('canon-scripts','extDataTimeline', array(
        ...
        'excerptLength'         => $cmb_timeline_excerpt_length,
    ));        
        ...
        <div class="main-container">
            ...
            <div class="main wrapper clearfix">
                ...
                <div class="main-content">
                    ...
                    <h1><?php echo esc_attr($post->post_title); ?></h1>
                    ...
                    <div class="timeline-container">
                        ...
                        <div class="vert-line"></div>
                            ...
                            <ul class="timeline" data-offset="<?php echo esc_attr($timeline_offset); ?>">
                                ...
                                <?php 
                                    ...
                                    for ($i = 0; $i < count($results_query); $i++) { 
                                        ...
                                        $the_excerpt = mb_get_excerpt($this_post->ID, $cmb_timeline_excerpt_length);
